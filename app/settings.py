...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "rest_framework.authentication.SessionAuthentication",  # 👈 permite usar a sessão do admin
        "core.authentication.TokenAuthentication",              # 👈 continua funcionando para Passage ID
    ),
